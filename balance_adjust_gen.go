...
func (z *BalanceAdjust) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
...
func (z *BalanceAdjust) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 5
	// write "CommonHeader"
...
func (z *BalanceAdjust) MarshalMsg(b []byte) (o []byte, err error) {
...
func (z *BalanceAdjust) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
...
func (z *BalanceAdjust) Msgsize() (s int) {
	s = 1 + 13 + z.CommonHeader.Msgsize() + 2 + msgp.Int32Size + 2 + msgp.Int32Size + 2 + msgp.Int64Size + 2 + msgp.Int8Size
	return
}
